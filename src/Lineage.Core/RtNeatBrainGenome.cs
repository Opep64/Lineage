...
public static class RtNeatBrainIoRegistry
{
    ...
    public static float ReadInput(string key, in BrainInputFrame frame, in LegacyNeuralMemoryInputFrame memory)
    {
        return key switch
        {
            ...
            "internal.recent_meat_raw_yield" => frame.Internal.RecentMeatRawYield,
            "internal.recent_plant_energy_yield" => frame.Internal.RecentPlantEnergyYield,
            "internal.recent_meat_energy_yield" => frame.Internal.RecentMeatEnergyYield,
            ...
            "internal.recent_fresh_meat_energy_yield" => frame.Internal.RecentFreshMeatEnergyYield,
            "internal.recent_stale_meat_energy_yield" => frame.Internal.RecentStaleMeatEnergyYield,
            ...
            "internal.fresh_meat_payoff_trace" => frame.Internal.FreshMeatPayoffTrace,
            "internal.stale_meat_payoff_trace" => frame.Internal.StaleMeatPayoffTrace,
            ...
            "climate.current_temperature" => frame.Body.CurrentTemperature,
            "climate.forward_temperature" => frame.Body.ForwardTemperature,
            "climate.left_temperature" => frame.Body.LeftTemperature,
            "climate.right_temperature" => frame.Body.RightTemperature,
            "climate.current_thermal_mismatch" => frame.Body.CurrentThermalMismatch,
            "climate.forward_thermal_mismatch" => frame.Body.ForwardThermalMismatch,
            "climate.left_thermal_mismatch" => frame.Body.LeftThermalMismatch,
            "climate.right_thermal_mismatch" => frame.Body.RightThermalMismatch,
            ...
            "contact.creature_lineage_similarity" => frame.Body.CreatureContactLineageSimilarity,
            "contact.egg_lineage_similarity" => frame.Body.EggContactLineageSimilarity,
            ...
            "scent.creature_lineage_density" => frame.Scent.CreatureLineage.Density,
            "scent.creature_lineage_forward" => frame.Scent.CreatureLineage.DirectionForward,
            "scent.creature_lineage_right" => frame.Scent.CreatureLineage.DirectionRight,
            "scent.egg_lineage_density" => frame.Scent.EggLineage.Density,
            "scent.egg_lineage_forward" => frame.Scent.EggLineage.DirectionForward,
            "scent.egg_lineage_right" => frame.Scent.EggLineage.DirectionRight,
            "scent.creature_identity_density" => frame.Scent.CreatureIdentity.Density,
            "scent.creature_identity_forward" => frame.Scent.CreatureIdentity.DirectionForward,
            "scent.creature_identity_right" => frame.Scent.CreatureIdentity.DirectionRight,
            "scent.egg_identity_density" => frame.Scent.EggIdentity.Density,
            "scent.egg_identity_forward" => frame.Scent.EggIdentity.DirectionForward,
            "scent.egg_identity_right" => frame.Scent.EggIdentity.DirectionRight,
            "contact.creature_identity_similarity" => frame.Body.CreatureContactIdentitySimilarity,
            "contact.egg_identity_similarity" => frame.Body.EggContactIdentitySimilarity,
