        ...
        return BuildLivingClusters(state, resolvedOptions)
            ...
            .Select((cluster, index) =>
            {
                ...
                return new SpeciesClusterBehaviorFingerprint(
                    ...
                    EggFamiliarityResponse: behavior.EggFamiliarityResponse,
                    RiskResponse: behavior.RiskResponse,
                    TerrainResponse: behavior.TerrainResponse,
                    CollisionResponse: behavior.CollisionResponse,
                    ...
                    ObstacleBlockedMoveForward: behavior.ObstacleBlocked.MoveForward,
                    CreatureBlockedMoveForward: behavior.CreatureBlocked.MoveForward,
                    CreatureBlockedAttackShare: behavior.CreatureBlocked.AttackShare,
...
public readonly record struct SpeciesClusterBehaviorFingerprint(
    ...
    float ObstacleBlockedMoveForward,
    float CreatureBlockedMoveForward,
    float CreatureBlockedAttackShare,
