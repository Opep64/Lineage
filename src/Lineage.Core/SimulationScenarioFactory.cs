    ...
    public static ISimulationSystem[] CreatePipeline(SimulationScenario scenario)
    {
        return scenario.PipelineKind switch
        {
            SimulationPipelineKind.Neural => SimulationPipelines.CreateNeuralLifeLoop(
                ...
                scenario.StaleMeatDecayMultiplier,
                ...
                scenario.EnableCreatureCollision,
                scenario.CreatureCollisionSafeImpactSpeed,
                scenario.CreatureCollisionDamageScale,
                scenario.CreatureCollisionSeparationIterations,
                scenario.EnableInjuryMemory,
                scenario.InjuryMemoryHalfLifeSeconds,
                scenario.InjuryMemoryDamageSignalScale,
