...
public static class BrainIoRegistry
{
    ...
    private static BrainInputDefinition[] BuildInputs()
    {
        ...
        inputs.AddRange(new[]
        {
            ...
            Input("internal.recent_meat_raw_yield", "Recent meat raw yield", NeuralBrainSchema.RecentMeatRawYieldInput, BrainIoSignalGroup.Internal, 0f, 1f, 0f, BrainInputFreshnessPolicy.InternalOrContactFresh, "Recent raw meat calories transferred into the gut.", introducedVersion: 14),
            Input("internal.recent_meat_energy_yield", "Recent meat energy yield", NeuralBrainSchema.RecentMeatEnergyYieldInput, BrainIoSignalGroup.Internal, 0f, 1f, 0f, BrainInputFreshnessPolicy.InternalOrContactFresh, "Recent meat digestion energy released.", introducedVersion: 14),
            Input("internal.recent_fresh_meat_energy_yield", "Recent fresh meat energy yield", NeuralBrainSchema.RecentFreshMeatEnergyYieldInput, BrainIoSignalGroup.Internal, 0f, 1f, 0f, BrainInputFreshnessPolicy.InternalOrContactFresh, "Recent fresh meat digestion energy released.", introducedVersion: 14),
            Input("internal.recent_stale_meat_energy_yield", "Recent stale meat energy yield", NeuralBrainSchema.RecentStaleMeatEnergyYieldInput, BrainIoSignalGroup.Internal, 0f, 1f, 0f, BrainInputFreshnessPolicy.InternalOrContactFresh, "Recent stale meat digestion energy released.", introducedVersion: 14),
            Input("internal.fresh_meat_payoff_trace", "Fresh meat payoff trace", NeuralBrainSchema.FreshMeatPayoffTraceInput, BrainIoSignalGroup.Internal, 0f, 1f, 0f, BrainInputFreshnessPolicy.InternalOrContactFresh, "Decaying trace of fresh meat digestion payoff.", introducedVersion: 14),
            Input("internal.stale_meat_payoff_trace", "Stale meat payoff trace", NeuralBrainSchema.StaleMeatPayoffTraceInput, BrainIoSignalGroup.Internal, 0f, 1f, 0f, BrainInputFreshnessPolicy.InternalOrContactFresh, "Decaying trace of stale meat digestion payoff.", introducedVersion: 14)
        });
