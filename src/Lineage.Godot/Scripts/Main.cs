...
public partial class Main : Node2D
{
    ...
    private void UpdateLabels()
    {
        ...
        _runtimeStatsLabel.Text =
            ...
            $"Kin scent {FormatPercent(Share(snapshot.CreatureSimilarityScentDetectedCreatureCount, snapshot.CreatureCount))}  lineage {FormatPercent(Share(snapshot.CreatureLineageScentDetectedCreatureCount, snapshot.CreatureCount))}  egg {FormatPercent(Share(snapshot.EggLineageScentDetectedCreatureCount, snapshot.CreatureCount))}  density {snapshot.AverageCreatureSimilarityScentDensity:0.00}/{snapshot.AverageCreatureLineageScentDensity:0.00}/{snapshot.AverageEggLineageScentDensity:0.00}\n" +
