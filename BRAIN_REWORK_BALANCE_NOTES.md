...
7. Introduce BrainFactory / multiple brain architecture support after the standardized input/output frame is real enough to avoid abstracting the wrong thing.
